...
type ProjectPreviewProps = { desktopSrc: string; mobileSrc: string; alt: string; className?: string };
const ProjectPreview = ({ desktopSrc, mobileSrc, alt, className = "" }: ProjectPreviewProps) => (
  <figure className={`photo project-photo project-preview ${className}`}>
    <picture>
    ...
    <main>
      ...
      <section className="work section" id="work">
        ...
        <div className="project-grid">
          <article className="project"><ProjectPreview className="motionlab image-reveal" desktopSrc="/projects/motionlab/preview-desktop.png" mobileSrc="/projects/motionlab/preview-mobile.png" alt="MotionLab Physiotherapie website preview showing the digital patient experience" /><div className="project-content"><span>Strategy · UX/UI · Website</span><h3>MotionLab<br />Physiotherapie</h3><dl><div><dt>Challenge</dt><dd>Make professional expertise feel clear and human before the first appointment.</dd></div><div><dt>Solution</dt><dd>A movement-led identity and focused journey built around patient questions, not practice jargon.</dd></div><div><dt>Result</dt><dd>A calmer first impression, faster orientation and more confidence in taking the next step.</dd></div></dl><a href="mailto:hello@wetworldwanderlust.com?subject=MotionLab%20case%20study">Explore the project <Arrow /></a></div></article>
          <article className="project"><ProjectPreview className="wilfried image-reveal" desktopSrc="/projects/wilfried-soehne/preview-desktop.png" mobileSrc="/projects/wilfried-soehne/preview-mobile.png" alt="Wilfried & Söhne Steuerberatung website preview combining heritage with modern clarity" /><div className="project-content"><span>Positioning · Website · Development</span><h3>Wilfried & Söhne<br />Steuerberatung</h3><dl><div><dt>Challenge</dt><dd>Show a trusted family practice as contemporary without losing its history or credibility.</dd></div><div><dt>Solution</dt><dd>An editorial digital presence balancing personal continuity with precise, modern clarity.</dd></div><div><dt>Result</dt><dd>More character, easier navigation and a brand that feels established rather than old-fashioned.</dd></div></dl><a href="mailto:hello@wetworldwanderlust.com?subject=Wilfried%20%26%20S%C3%B6hne%20case%20study">See the process <Arrow /></a></div></article>
