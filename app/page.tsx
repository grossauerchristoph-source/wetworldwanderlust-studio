    ...
    <main>
      ...
      <section className="work section" id="work">
        ...
        <div className="project-grid">
          <article className="project website-project"><WebsitePreview src="/projects/visalpina/visalpina-fullpage.webp" label="Vis Alpina" alt="Full-page Vis Alpina premium coffee brand experience" /><div className="project-content"><span>Brand Identity · Editorial Design · Motion Design · Case Study</span><h3>Vis Alpina</h3><p className="project-subtitle">A premium coffee brand crafted through editorial design, materiality and purposeful motion.</p><dl><div><dt>Category</dt><dd>Editorial Brand Experience</dd></div><div><dt>Role</dt><dd>Creative Direction · Brand Strategy · Editorial Design · Interaction Design · Motion Design · Frontend Development</dd></div><div><dt>Technology</dt><dd>Next.js · React · TypeScript · Tailwind CSS · GSAP · Framer Motion</dd></div></dl><ProjectModalTrigger triggerLabel="Explore Vis Alpina" title="Vis Alpina" goal="Editorial Brand Experience" approach="A premium coffee brand crafted through editorial design, materiality and purposeful motion." outcome="A calm digital product shaped by precision, ritual and craft." kind="website" imageSrc="/projects/visalpina/visalpina-fullpage.webp" imageAlt="Full-page Vis Alpina premium coffee brand experience" details={[{ label: "Overview", content: "Vis Alpina is an editorial brand experience exploring how craftsmanship, alpine character and specialty coffee can be translated into a calm digital product.\n\nProject role: Creative Direction · Brand Strategy · Editorial Design · Interaction Design · Motion Design · Frontend Development" }, { label: "Challenge", content: "Translate craftsmanship, alpine character and specialty coffee into a distinctive digital identity without relying on familiar luxury or coffee clichés." }, { label: "Research", content: "The experience was developed through an iterative process beginning with research and material exploration, then refined through art direction, interface design, motion design and frontend implementation." }, { label: "Materiality", content: "Materiality became a primary carrier of identity, communicating craft more effectively than obvious symbolism." }, { label: "Art Direction", content: "Typography, materiality and photography create a distinctive identity with editorial restraint." }, { label: "Interface Design", content: "A calm interface turns the brand's alpine character and specialty-coffee ritual into a precise digital product." }, { label: "Motion Design", content: "Restrained, purposeful motion reinforces the storytelling without competing with the content." }, { label: "Implementation", content: "Next.js · React · TypeScript · Tailwind CSS · GSAP · Framer Motion" }, { label: "Final Experience", content: "Every interaction supports the feeling of precision, ritual and craft." }, { label: "Key Learnings", content: "• Editorial restraint creates stronger brand perception than excessive visual effects.\n• Materiality can communicate identity more effectively than obvious symbolism.\n• Motion should reinforce storytelling rather than compete with the content.\n• Iteration consistently improved clarity more than adding new features." }]} /></div></article>
