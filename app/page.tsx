import { UgcVideo, VideoPlayCta, WebsitePreview } from "./ProjectMedia";
    ...
    <main>
      ...
      <section className="work section" id="work">
        ...
        <div className="project-grid">
          <article className="project website-project" id="motionlab-project"><WebsitePreview src="/projects/motionlab/motionlab-fullpage.png" label="MotionLab Physiotherapie" alt="Full-page MotionLab Physiotherapie website design" /><div className="project-content"><span>Strategy · UX/UI · Website</span><h3>MotionLab<br />Physiotherapie</h3><dl><div><dt>Goal</dt><dd>Help a modern physiotherapy practice communicate trust before the first appointment.</dd></div><div><dt>Approach</dt><dd>Calm editorial design, clear typography and a patient journey built around reassurance.</dd></div><div><dt>Outcome</dt><dd>A premium first impression that encourages visitors to book with confidence.</dd></div></dl><a href="#motionlab-project" aria-label="Explore the MotionLab project — case study coming soon">Explore the project <small>Case study coming soon</small><Arrow /></a></div></article>
          <article className="project website-project" id="wilfried-project"><WebsitePreview src="/projects/wilfried-soehne/wilfried-soehne-fullpage.png" label="Wilfried & Söhne Steuerberatung" alt="Full-page Wilfried & Söhne Steuerberatung website design" /><div className="project-content"><span>Positioning · Website · Development</span><h3>Wilfried & Söhne<br />Steuerberatung</h3><dl><div><dt>Goal</dt><dd>Present a traditional advisory service with clarity, confidence and modern relevance.</dd></div><div><dt>Approach</dt><dd>A structured editorial system combining professional authority with accessible communication.</dd></div><div><dt>Outcome</dt><dd>A digital presence that feels established, trustworthy and easier to understand.</dd></div></dl><a href="#wilfried-project" aria-label="See the Wilfried & Söhne process — case study coming soon">See the process <small>Case study coming soon</small><Arrow /></a></div></article>
          <article className="project ugc-project"><UgcVideo src="/projects/ugc/showcase-web.m4v" poster="/projects/ugc/showcase-poster.jpeg" /><div className="project-content"><span>UGC · Brand storytelling</span><h3>Brand Storytelling</h3><p className="ugc-supporting">Human product stories designed to feel like a recommendation, not an advertisement.</p><dl><div><dt>Goal</dt><dd>Create short-form content that earns attention without feeling like a traditional advertisement.</dd></div><div><dt>Approach</dt><dd>Natural performance, platform-native storytelling and editing built around the rhythm of the product.</dd></div><div><dt>Outcome</dt><dd>Credible content that feels like a recommendation and supports brand trust.</dd></div></dl><VideoPlayCta /></div></article>
        </div>
      </section>
